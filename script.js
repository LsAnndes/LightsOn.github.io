document.addEventListener("DOMContentLoaded", function(event) {
  const img1Replace = new Image();
    ...
    img4Replace.src = 'img4replace.png';

      const img5Replace = new Image();
    img5Replace.src = 'img5replace.png';

      const img6Replace = new Image();
    img6Replace.src = 'img6replace.png';

      const img7Replace = new Image();
    img7Replace.src = 'img7replace.png';

    const img8Replace = new Image();
    img8Replace.src = 'img8replace.png';

     const img9Replace = new Image();
    img9Replace.src = 'img9replace.png';
